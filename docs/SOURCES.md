...
The bundled list is 17,808 employer job boards, read straight from the
...
17,812 sources, **6,090 carry a sector tag and 11,722 carry none**: the harvest
...
`sources.countries: [UK]` leaves 7,746 sources rather than the 934 tagged
...
17,808 boards runs in a private maintainer repository, so that forking this
